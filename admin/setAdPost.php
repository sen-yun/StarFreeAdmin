...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $pushAdsPrice = (int)$_POST['pushAdsPrice'];
    $pushAdsNum = (int)$_POST['pushAdsNum'];
    $bannerAdsPrice = (int)$_POST['bannerAdsPrice'];
    $bannerAdsNum = (int)$_POST['bannerAdsNum'];
    $startAdsPrice = (int)$_POST['startAdsPrice'];
    $startAdsNum = (int)$_POST['startAdsNum'];
    ...
    if (isset($_SESSION['loginadmin']) && $_SESSION['loginadmin'] <> '') {
        ...
        $params = array(  
        'adsVideoType' => $adsVideoType,  
        'adsSecuritykey' => $adsSecuritykey,  
        'pushAdsPrice' => $pushAdsPrice,
        'pushAdsNum' => $pushAdsNum,
        'bannerAdsPrice' => $bannerAdsPrice,
        'bannerAdsNum' => $bannerAdsNum,
        'startAdsPrice' => $startAdsPrice,
        'startAdsNum' => $startAdsNum,
        'adsGiftNum' => $adsGiftNum,
        'adsGiftAward' => $adsGiftAward
        );  
