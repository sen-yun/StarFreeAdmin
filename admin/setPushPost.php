...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $pushAppId = $_POST['pushAppId'];  
    $pushAppKey = $_POST['pushAppKey'];
    $pushMasterSecret = $_POST['pushMasterSecret'];
    $isPush = isset($_POST['isPush']) && $_POST['isPush'] == 1 ? true : false;  
    ...
    if (isset($_SESSION['loginadmin']) && $_SESSION['loginadmin'] <> '') {
        ...
        'pushMasterSecret' => $pushMasterSecret,
        'isPush' => $isPush
        );  
