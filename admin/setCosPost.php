...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $cosAccessKey = $_POST['cosAccessKey'];
    $cosSecretKey = $_POST['cosSecretKey'];
    $cosBucket = $_POST['cosBucket'];
    $cosBucketName = $_POST['cosBucketName'];
    $cosPath = $_POST['cosPath'];
    $cosPrefix = $_POST['cosPrefix'];
