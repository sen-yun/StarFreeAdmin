...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $violationExp = $_POST['violationExp'];
    $deleteExp = $_POST['deleteExp'];
    $spaceMinExp = $_POST['spaceMinExp'];
    $chatMinExp = $_POST['chatMinExp'];
    $disableCode = isset($_POST['disableCode']) && $_POST['disableCode'] == 1 ? true : false;  
    $allowDelete = isset($_POST['allowDelete']) && $_POST['allowDelete'] == 1 ? true : false;  
    ...
    if (isset($_SESSION['loginadmin']) && $_SESSION['loginadmin'] <> '') {
        ...
        $params = array(  
        'postMax' => (int)$postMax,
        'violationExp' => $violationExp,
        'deleteExp' => $deleteExp,
        'spaceMinExp' => $spaceMinExp,
        'chatMinExp' => $chatMinExp,
